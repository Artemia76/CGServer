...
void CCiel::Sauve ()
{
	...
	// Couleurs de la nuit
	pConfig->Write(_T("Couleurs/NN"), NN.GetHTML());
	pConfig->Write(_T("Couleurs/NS"), NS.GetHTML());
	pConfig->Write(_T("Couleurs/NE"), NE.GetHTML());
	pConfig->Write(_T("Couleurs/NO"), NO.GetHTML());
	pConfig->Write(_T("Couleurs/NZ"), NZ.GetHTML());
	pConfig->Write(_T("Couleurs/ND"), ND.GetHTML());
	pConfig->Write(_T("Couleurs/NA"), NA.GetHTML());
	pConfig->Write(_T("Couleurs/NL"), NL.GetHTML());
	// Couleurs de l'aube
	pConfig->Write(_T("Couleurs/AN"), AN.GetHTML());
	pConfig->Write(_T("Couleurs/AS"), AS.GetHTML());
	pConfig->Write(_T("Couleurs/AE"), AE.GetHTML());
	pConfig->Write(_T("Couleurs/AO"), AO.GetHTML());
	pConfig->Write(_T("Couleurs/AZ"), AZ.GetHTML());
	pConfig->Write(_T("Couleurs/AD"), AD.GetHTML());
	pConfig->Write(_T("Couleurs/AA"), AA.GetHTML());
	pConfig->Write(_T("Couleurs/AL"), AL.GetHTML());
	// Couleurs du jour
	pConfig->Write(_T("Couleurs/JN"), JN.GetHTML());
	pConfig->Write(_T("Couleurs/JS"), JS.GetHTML());
	pConfig->Write(_T("Couleurs/JE"), JE.GetHTML());
	pConfig->Write(_T("Couleurs/JO"), JO.GetHTML());
	pConfig->Write(_T("Couleurs/JZ"), JZ.GetHTML());
	pConfig->Write(_T("Couleurs/JD"), JD.GetHTML());
	pConfig->Write(_T("Couleurs/JA"), JA.GetHTML());
	pConfig->Write(_T("Couleurs/JL"), JL.GetHTML());
	// Couleurs du crépuscule
	pConfig->Write(_T("Couleurs/CN"), CN.GetHTML());
	pConfig->Write(_T("Couleurs/CS"), CS.GetHTML());
	pConfig->Write(_T("Couleurs/CE"), CE.GetHTML());
	pConfig->Write(_T("Couleurs/CO"), CO.GetHTML());
	pConfig->Write(_T("Couleurs/CZ"), CZ.GetHTML());
	pConfig->Write(_T("Couleurs/CD"), CD.GetHTML());
	pConfig->Write(_T("Couleurs/CA"), CA.GetHTML());
	pConfig->Write(_T("Couleurs/CL"), CL.GetHTML());
	pConfig->Flush();
}
...
void CCiel::MAJ()
{
	...
	aw_string_set(AW_WORLD_LIGHT_TEXTURE,Astre);
	aw_string_set(AW_WORLD_LIGHT_MASK,MAstre);
...
void CCiel::CalcCoul (CColour& C1, CColour& C2, CColour& Re, int hd, int hf , int h)
{
